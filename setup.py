...
setup(name                           = 'bidscoin',                          # Required
      ...
      scripts                        = ['bidscoin'+path.sep+'bidstrainer.py', 'bidscoin'+path.sep+'bidsmapper.py', 'bidscoin'+path.sep+'bidscoiner.py', 'bidscoin'+path.sep+'rawmapper.py', 'bidscoin'+path.sep+'dicomsort.py'],
      python_requires                = '>=3',
