...
def raw_dicomdir(tmp_path_factory):
    ...
    dicomfile.replace(dicomfile.parent/'_.dcm')                         # Make sure this is the first file when sorted
    sourcesidecar = raw/'Doe^Peter'/'03-Brain'/'002-TSC RF FAST PILOT/_.json'
