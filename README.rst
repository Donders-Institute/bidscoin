...
Because all the mapping information can be easily edited with a `Graphical User Interface (GUI) <./_static/screenshots.html>`__, BIDScoin requires no programming knowledge in order to use it.
