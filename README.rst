...
Data conversions are performed within plugins, such as plugins that use `dcm2niix <https://github.com/rordenlab/dcm2niix>`__, `spec2nii <https://github.com/wexeee/spec2nii>`__ or `nibabel <https://nipy.org/nibabel>`__.
