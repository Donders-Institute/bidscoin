...
def bidsmapper_plugin(seriesfolder: str, bidsmap: dict, heuristics: dict, logger: object) -> dict:
    """
...
def bidscoiner_plugin(session: str, bidsmap: dict, bidsfolder: str, personals: dict, logger: object) -> None:
    """
