...
def get_parser():
    ...
    parser.add_argument('-p','--participant', help="Space separated list of sub-# identifiers to be processed (the sub-prefix can be left out). If not specified then all participants will be processed", type=str, nargs='+')
