...
file generated by >=R015 sequences. You can also import the internal 'readphysio` library function in python
...
physio['Freq']:     Sampling frequency (= 1/clock-tick; The unit of time is clock-ticks, which normally is 2.5 ms)
