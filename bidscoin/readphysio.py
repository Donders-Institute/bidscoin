...
You can also import the internal 'readphysio` library function in python to obtain active physio traces
for ECG1, ECG2, ECG3, ECG4, RESP, PULS, EXT and EXT2 signals:
