...
.. tip::
   Make a copy of the DCCN template (``[path_to_bidscoin]/heuristics/bidsmap_dccn.yaml``) as a starting point for your own template bidsmap, and adapt it to your environment. You can test your bidsmap with: ``bidscoin -t fullpath_to/my_template_bidsmap.yaml``
